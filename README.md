...
This is a complete **v1**: seventeen interacting elements with a per-cell
...
![Elements](docs/screenshots/elemental.png)
*All 17 elements.*

![Volcano](docs/screenshots/volcano.png)
*Lava, sand (→ glass at the interface), fire, and smoke.*

![Water cycle](docs/screenshots/water_cycle.png)
*Dry ice freezing water on the left; fire boiling it to steam on the right.*

![Oil fire on water](docs/screenshots/oil_fire.png)
*Oil floats on water and burns across the surface.*

![Explosion](docs/screenshots/explosion.png)
*Gunpowder detonating — crater, scatter, fireball.*

![Acid and base](docs/screenshots/acid_base.png)
*Acid dissolving sand; base dissolving glass; neutralization steam.*

![Heat overlay](docs/screenshots/heat_overlay.png)
*The volcano scene in heat-map mode — temperature distribution from blue (cold) to red (hot).*
